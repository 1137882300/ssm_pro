    ...
    <div class="jq22-comm-box clearfix" style="padding: 5px">
        ...
        <div class="jq22-nav-nav" style="margin: 12px">
            <dl class="clearfix" style="margin: auto">
                ...
                <dd>
                    <h3>
                        <a href="${pageContext.request.contextPath}/typeController/findType?type=5" class="active">绿色蔬菜</a>
                    </h3>
                    ...
                    <c:if test="${s.index == 1}">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="product-item">
                                <a href="${pageContext.request.contextPath}/detailGoodsController/toDetailGoods?gid=${list.gid}" target="_blank">
                                    <!--图片-->
                                ...
                                <div class="product-caption">
                                    <h4 class="product-name">
                                        <a href="${pageContext.request.contextPath}/detailGoodsController/toDetailGoods?gid=${list.gid}" target="_blank">${list.gname}</a>
                                    </h4>
                                    <!--钱*现价-->
